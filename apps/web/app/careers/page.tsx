  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-dark to-gray-900 flex items-center justify-center px-6">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-300 mb-8">We're building something amazing. Check back soon for career opportunities at HostelFinder!</p>
        
        <div className="space-y-6">
          <p className="text-gray-400">Join our team and help us revolutionize student housing.</p>
