  ...
  return (
    <section className="py-20 bg-brand-dark text-white">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="font-display font-bold text-4xl md:text-5xl mb-6">Still have questions?</h2>
        <p className="text-gray-300 text-lg mb-10">
          Check out our help center or press kit for more information about HostelFinder.
        </p>
