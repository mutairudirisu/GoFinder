...
export function JourneyScroller() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden z-40 bg-white px-16 h-screen">
      ...
      <div className="relative mx-auto px-4 sm:px-6 py-20 sm:py-28">
        ...
        <div className="mt-14 relative h-[220vh]">
          <motion.div
            style={{ clipPath }}
