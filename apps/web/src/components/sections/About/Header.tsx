    ...
    <header className="fixed top-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-md border-b-2 border-brand-dark">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 font-sans font-medium">
          ...
          <button onClick={() => router.push('/about-us')} className="relative text-brand-dark py-2">
            About Us
          ...
          <button onClick={() => router.push('/contact')} className="text-slate-500 hover:text-brand-dark transition-colors">Contact</button>
        </nav>
