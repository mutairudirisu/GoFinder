          ...
          >
            {showSpecificLocation ? (
              <div className="relative flex flex-col items-center group/marker cursor-pointer">
                {price ? (
                  <div className="bg-white px-4 py-2 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.15)] border-2 border-brand-500 font-bold text-slate-900 transition-all hover:scale-110 active:scale-95">
