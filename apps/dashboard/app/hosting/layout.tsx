...
function HostingLayoutContent({
  ...
  useEffect(() => {
    ...
    const handler = () => {
      ...
      if (localStorage.getItem('gigs_request_category_overlay') === 'true') {
        setIsCategoryOverlayOpen(true);
        localStorage.removeItem('gigs_request_category_overlay');
      }
    };
      ...
      <BottomTabNav
        ...
        items={[
          { key: "today", href: "/hosting", label: "Today", iconClassName: "ph-bold ph-bookmark-simple text-xl", isActive: isTodayRoute },
          {
            ...
            href: "#",
            label: "Create",
            iconClassName: "ph-bold ph-plus-circle text-xl",
