    ...
    <div className="max-w-3xl mx-auto px-4 py-6 md:py-10">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl md:text-3xl font-display font-semibold text-slate-900">Past trips</h2>
        </div>

        <div className="flex flex-col items-center text-center space-y-8">
          <div className="relative w-48 h-48 md:w-64 md:h-64">
            <img 
              src="https://img.viva.com.vn/2023/12/01/airbnb-suitcase.png" 
              alt="Past trips" 
              className="w-full h-full object-contain"
              onError={(e) => {
                // Fallback if the image link doesn't work
                (e.target as any).src = "https://cdn-icons-png.flaticon.com/512/2664/2664531.png";
              }}
            />
          </div>
          ...
          <div className="space-y-2 max-w-sm">
            <p className="text-slate-600 font-medium">
              You'll find your past reservations here after you've taken your first trip on GIGS.
            </p>
          </div>
